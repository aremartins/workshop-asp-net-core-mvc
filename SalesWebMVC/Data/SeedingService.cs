...
namespace SalesWebMVC.Data
{
    ...
    {
        private readonly SalesWebMVCContext _context; //registra o serviço do seedingservice com o dbcontext
        ...
        //aqui foi criado o serviço de injeção de dependência, ou seja quando um Seeding Service for criado
        //automaticamente recebe uma instância do _context também.
        ...
        public void Seed()
        {
            ...
            {
                return; //Se o bd ja estiver populado, não acontece nada
            }
